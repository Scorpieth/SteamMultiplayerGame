...
public static partial class Steam
{
    ...
    public static SteamInitResult SteamInit(int steamAppID, bool retrieveStats = true)
    {
        var raw = GetInstance().Call(Methods.SteamInit, retrieveStats, steamAppID).AsGodotDictionary();
